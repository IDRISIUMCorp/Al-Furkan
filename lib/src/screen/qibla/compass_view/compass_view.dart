...
class CompassView extends CustomPainter {
    ...
    for (int degree = 0; degree < 360; degree++) {
      if (degree % 2 == 0) {
        ...
        if (is30) {
          ...
          textPainter.paint(
            canvas,
            Offset(-textPainter.width / 2, -(degreeDistanceFromCenter - 25)),
          );
          ...
          if (is90) {
            ...
            textPainter.paint(
              canvas,
              Offset(-textPainter.width / 2, -(degreeDistanceFromCenter - 55)),
            );
          }
          canvas.restore();
        }
  ...
  @override
  bool shouldRepaint(covariant CompassView oldDelegate) {
    return oldDelegate.kaabaAngle != kaabaAngle ||
        oldDelegate.themeState.primary != themeState.primary;
  }
}
